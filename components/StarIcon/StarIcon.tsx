...
export const StarIcon = forwardRef(({ id='none', isEditable=false, className, ...props }: StarIconProps, ref: ForwardedRef<HTMLDivElement>): JSX.Element => {
	switch (id) {
		case 'none':
			return (
				<div	{...props}
		...
		case 'filled':
			return (
				...
				>
				<svg
					className={cn(className, styles.svg, styles.filled, {
					[styles.editable]: isEditable
					})}					
					width="20" height="20" viewBox="0 0 20 20" fill="#E2E2E2" xmlns="http://www.w3.org/2000/svg"
				>
